...
//         idempotency check
    ...
    private boolean simulatePayment(java.math.BigDecimal amount) {
        // Deterministic stand-in for a real payment gateway (Stripe/Razorpay/etc.).
        // Rule: amounts evenly divisible by 10 FAIL; everything else SUCCEEDS.
        // This lets you exercise both the success and failure (DLQ/retry) paths on demand.
